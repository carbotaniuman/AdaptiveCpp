...
#define HIPSYCL_MATH_BUILTIN_GENERATOR_BINARY_T_TGENPTR(T, builtin_name, builtin_func) \
...
#define HIPSYCL_MATH_BUILTIN_GENERATOR_BINARY_T_INTGENPTR(T, builtin_name, builtin_func) \
  template<typename Ptr>                                                                 \
  HIPSYCL_BUILTIN                                                                        \
  std::enable_if_t<                                                                      \
...
#define HIPSYCL_MATH_BUILTIN_GENERATOR_TERNARY_T(T, builtin_name, builtin_func) \
  HIPSYCL_BUILTIN T builtin_name(T x, T y, T z) {                               \
...
#define HIPSYCL_MATH_BUILTIN_GENERATOR_TEMPLATE_BINARY_T_TGENPTR(tester, builtin_name, builtin_func) \
...
#define HIPSYCL_MATH_BUILTIN_GENERATOR_TEMPLATE_BINARY_T_INTGENPTR(tester, builtin_name, builtin_func) \
  template<typename NonScalar1, typename Ptr>                                                          \
  HIPSYCL_BUILTIN                                                                                      \
  std::enable_if_t<                                                                                    \
    detail::builtin_inputs_are_compatible_v<                                                           \
    ...
    >,                                                                                                 \
    detail::builtin_input_return_t<NonScalar1>                                                         \
  > builtin_name(NonScalar1 x, Ptr iptr) {                                                             \
    detail::builtin_input_return_t<NonScalar1> ret;                                                    \
    detail::builtin_input_intlike_t<NonScalar1>& y = *iptr;                                            \
    for (std::size_t i = 0; i < detail::builtin_input_num_elems_v<NonScalar1>; i++) {                  \
      ret[i] = builtin_name(x[i], &y[i]);                                                              \
    }                                                                                                  \
    return ret;                                                                                        \
  }
...
#define HIPSYCL_BUILTIN_OVERLOADED_IMPL_MATH(h, template_h, builtin_name, builtin_func) \
  ...
  h(half, builtin_name, builtin_func)                                             \
...
HIPSYCL_MATH_BUILTIN(BINARY_T_TGENPTR, fract)
HIPSYCL_MATH_BUILTIN(BINARY_T_INTGENPTR, frexp)
...
HIPSYCL_MATH_BUILTIN(BINARY_T_INTGENPTR, lgamma_r)
...
HIPSYCL_MATH_BUILTIN(BINARY_T_TGENPTR, modf)
// TODO nancode
...
HIPSYCL_MATH_BUILTIN(BINARY_T_TGENPTR, sincos)
